...
informativity_product_plot <- ggplot(data = 
  ...
  ggtitle("Wahrgenommene Informativtät") + 
  labs(caption = "Bayesian repeated measurement ANOVA: BF10 > 100,
         0,74 ≤ U3 ≤ 0,92") +
  ylab("") + 
  xlab("") 

ggsave("study1_informativity_product_plot.png", 
...
interpretation_product_plot <- ggplot(data = 
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),
        ...
        plot.caption = element_text(size=15),
        strip.text = element_text(size = 14)) +
  ggtitle("Interpretation der statistischen Beschreibungen") + 
    labs(caption = "Bayesian repeated measurement ANOVA: BF01 = 67,15,
         0,46 ≤ U3 ≤ 0,56") +
  ylab("") + 
  xlab("") 

ggsave("study1_interpretation_product_plot.png", 
