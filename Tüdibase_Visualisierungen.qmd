  ...
  stat_summary(data = data_w %>% 
        ...
        mutate(group = recode_factor(group,
         ...
         mutate(var = fct_relevel(var,
               ...
               color = "black") + 
  theme_ipsum_ps(axis_text_size = "15") + 
...
ggsave("study3_plot_informativity.png",
      width = 9,
      height = 9,
      dpi = 400)
```
...
plot_diff_am <- data_w  |> 
  ...
  ggplot(aes(diff_am, group)) +
    ...
    xlab("Differenz: geschätze Effektstärke (transformiert in Cohen's d) - wahre Effektstärke") +
    ylab("Experimetalbedingungen")

plot_diff_am 

ggsave("study3_plot_diff_am.png",
      width = 8,
      height = 8,
      dpi = 400)
```
...
ggsave("study3_plot_diff_u3.png",
      width = 8,
      height = 8,
      dpi = 400)
```
...
ggsave("study3_plot_u3_misconceptions.png",
      width = 8,
      height = 8,
      dpi = 400)
```
